...
var    name22 =binding.prodname.text.toString()
  var price22=binding.prodprice.text.toString()
   var quan22 =  binding.prodquan.text.toString()
    if(name22!=null&& price22!=null&&quan22!=null&&pic!=null && isnum(price22!!,quan22!!)&&name22.equals("")==false&&price22.equals("")==false&&quan22.equals("")==false){
    ...
    if(object1.productname.toString().equals(binding.prodname.text.toString()) == false){
        ...
        Toast.makeText(this, "please complete all required values and put the right values", Toast.LENGTH_LONG)
            .show()
    ...
    private  fun isnum (x1:String,x2:String):Boolean{
        var a1 = x1.toIntOrNull()
        var a2= x2.toIntOrNull()
        if(a1==null || a2==null ){
