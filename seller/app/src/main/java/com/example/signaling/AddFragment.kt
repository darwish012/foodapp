...
class AddFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        prodaddbutton.setOnClickListener{
            ...
            if(name!=null&& price!=null&&quan!=null&&pic!=null && isnum(price!!,quan!!)&&name.equals("")==false&&price.equals("")==false&&quan.equals("")==false){
               ...
               mAuth = FirebaseAuth.getInstance()
                ...
                Toast.makeText(requireActivity().application, "please complete all required values and put the right values", Toast.LENGTH_LONG)
                    .show()
